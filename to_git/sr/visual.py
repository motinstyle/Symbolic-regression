...
#     Args:
#         X: Input data (flattened for 1D plotting or shape (n_samples, 2) for 3D)
...
# def plot_error_history(errors, title="Error History"):
#     """Plot the evolution of error over epochs
#     Args:
#         errors: Array of error values
#         title: Plot title
#     """
#     plt.figure(figsize=(10, 6))
#     plt.plot(errors, 'b-', alpha=0.7)
#     plt.title(title)
#     plt.xlabel("Epoch")
#     plt.ylabel("Error")
#     plt.grid(True, alpha=0.3)
